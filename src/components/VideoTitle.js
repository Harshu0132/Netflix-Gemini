  ...
  return (
    <div className="flex flex-col absolute w-screen h-screen -ml-6 md:ml-0 md:mt-0 mt-6 justify-center bg-gradient-to-r from-black w-screen aspect-video text-white">
      <div className="w-[70vw] mx-auto">
        ...
        <div className="flex">
          <button className="bg-white text-black md:py-2 py-[6px] md:px-6 px-4 md:rounded-lg rounded-md hover:bg-opacity-40 flex items-center text-sm md:text-lg"><FaPlay className="me-2 md:text-xl text-xs" />Play</button>
